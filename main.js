...
const session_db = new DATABASE('service_courant_session_db', { session_code: null })

// setup_game('caca')

const setup_div = div().add2b().set_style({ margin: 'auto', width: 'fit-content', textAlign: 'center' }).add(
